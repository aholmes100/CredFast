...
export const FIELD_LABELS: Record<string, Record<string, string>> = {
  provider: {
    ...
    is_hospital_based:            'Hospital Based',
    is_w2:                        'W2 Employee',
    supervising_physician_npi:    'Supervising Physician NPI',
    supervising_physician_name:   'Supervising Physician Name',
    race:                         'Race',
    ethnicity:                    'Ethnicity',
    offers_telehealth:            'Offers Telehealth',
  },
  group: {
    name:                         'Practice Name',
  ...
  enrollment: {
    ...
    lob_commercial:           'LOB: Commercial',
    lob_medicare:             'LOB: Medicare',
    lob_medicaid:             'LOB: Medicaid',
    lob_marketplace:          'LOB: Marketplace',
    network_effective_date:   'Network Effective Date',
    network_termination_date: 'Network Termination Date',
  },
  static: {
